...
// // ===== UPDATED: Import from new backend utility functions =====
// import { createConversation, getDailyRoomUrl, endConversation } from "../utils/tavus"
// // ===== END UPDATE =====
...
//   // ===== REMOVED: Direct backend URL usage =====
...
//   // ===== UPDATED: Initialize Tavus conversation using backend =====
//   useEffect(() => {
...
//         console.log("Initializing Tavus conversation through backend...")

//         // Use backend endpoint instead of direct Tavus API call
//         const conversationData = await createConversation(
//           import.meta.env.VITE_TAVUS_PERSONA_ID, // Still get persona ID from frontend env if needed
//           mood,
//         )

//         setConversationId(conversationData.conversation_id)
//         console.log("Conversation created via backend:", conversationData.conversation_id)
//       } catch (err) {
//         console.error("Error initializing Tavus conversation:", err)
//         setError(err instanceof Error ? err.message : "Failed to initialize AI avatar")
//       } finally {
...
//   // ===== UPDATED: Initialize Daily call frame using backend =====
//   useEffect(() => {
...
//         console.log("Getting Daily room URL through backend...")

//         // Use backend endpoint instead of direct API call
//         const roomUrl = await getDailyRoomUrl(conversationId)

//         console.log("Daily room URL received:", roomUrl)
...
//         setError(err instanceof Error ? err.message : "Failed to connect to AI avatar")
//         setIsConnecting(false)
//       }
//     }
...
//   // ===== UPDATED: Handle close using backend =====
...
//       if (conversationId) {
//         console.log("Ending conversation through backend...")
...
//       // Still close the UI even if backend call fails
//       onClose()
//     }
//   }
//   // ===== END UPDATE =====
